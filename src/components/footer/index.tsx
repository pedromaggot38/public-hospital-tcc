    ...
    <footer className="bg-white lg:grid lg:grid-cols-5">
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <p>
              <span className="text-xs uppercase tracking-wide text-gray-500"> Ligue para nós </span>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <p className="font-medium text-gray-900">Companhia</p>

              <ul className="mt-6 space-y-4 text-sm">
                <li>
                  <a href="/about" className="text-gray-700 transition hover:opacity-75"> Sobre </a>
                </li>

                <li>
                  <a href="#" className="text-gray-700 transition hover:opacity-75"> Conheça a Equipe </a>
                </li>
