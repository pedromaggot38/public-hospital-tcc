          ...
          <div>
            ...
            <ul className="mt-8 flex gap-6">
              {socialLinks.map((link, index) => (
                <li key={index}>
                  <Link href={link.href} rel="noreferrer" target="_blank" className="text-gray-700 transition hover:opacity-75">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                {services.map((service, index) => (
                  <li key={index}>
                    <Link href={service.href} className="text-gray-700 transition hover:opacity-75">
                      {service.label}
                    </Link>
                  </li>
                ))}
