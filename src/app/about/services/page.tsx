  ...
  const medicalConsultations = [
    {
      ...
      description:
        "Nosso setor de Urgência e Emergência está preparado para atender prontamente a todas as situações críticas. Contamos com uma equipe de profissionais altamente qualificados e equipamentos modernos para garantir um atendimento rápido e eficaz.",
      image: "/ServicesAboutPage/emergencia.jpg",
      reverse: true,
    },
    {
      title: "Consulta com Ortopedista para Traumas e Fraturas",
      description:
      ...
      image: "/ServicesAboutPage/ortopedista.jpg",
      reverse: false,
    },
    {
      ...
      image: "/ServicesAboutPage/cirurgiao_geral.jpg",
      reverse: true,
    },
    {
      ...
      image: "/ServicesAboutPage/anestesia.jpg",
      reverse: false,
    },
  ];
  ...
  const medicalExams = [
    {
      ...
      image: "/ServicesAboutPage/radiografia.jpg",
      reverse: true,
    },
    {
      ...
      image: "/ServicesAboutPage/eletrocardiograma-ecg.jpg",
      reverse: false,
    },
    {
      ...
      image: "/ServicesAboutPage/laboratoriais.jpg",
      reverse: true,
    },
    {
      ...
      image: "/ServicesAboutPage/anatomopatologico.png",
      reverse: false,
    },
    {
      title: "Tococardiografia",
      description:
        "A tococardiografia é um exame importante para monitorar a saúde fetal durante a gravidez. Utilizamos equipamentos modernos para acompanhar a frequência cardíaca do bebê.",
      image: "/ServicesAboutPage/tococardiografia.jpg",
      reverse: true,
    },
  ];
